...
const Filling = () => {
        ...
        useEffect(() => {
          const fetchData = async () => {
            try {
              const response = await fetch('https://smartdashboardapi.azurewebsites.net/filling');
              if (response.ok) {
    ...
    return (
        <>
            ...
            <div className="accordion-item">
                ...
                <h6 className='bar-header-2'>Filling Unit Motor</h6>
                ...
                <div className="cota-box row">
                                <div className="col-2">
                                    ...
                                    <img className='loading-img' src="./img/filling.svg" alt="machine1" />
                                    ...
                                    <div className="row">
                                        <div className="col all-center">
                                            ...
                                            <div className="inner-data">
                                                ...
                                                <h4 className='cbm-h4'>{item.t2}</h4>
                                            </div>
                                            </div>
                                        ...
                                        <div className="col all-center">
                                            ...
                                            <img src="./img/wave.svg" alt="hot"  style={{width:"50px"}}/>
                                                <h4 className='cbm-h4'>{item.vB2}</h4>
                                            </div>
                                            </div>
                                        ...
                                        <div className="col all-center">
                                            ...
                                            <img src="./img/current.svg" alt="hot"  style={{width:"34px"}}/>
                                                <h4 className='cbm-h4'>{item.c2}</h4>
                                            </div>
                                            </div>
                                        ...
                                        <div className="col all-center">
                                            ...
                                            <img src="./img/Voltage.svg" alt="hot"  style={{width:"50px"}}/>
                                                <h4 className='cbm-h4'>{item.v2}</h4>
                                            </div>
                                            </div>
                                        ...
                                        <div className="col all-center">
                                            ...
                                            <img src="./img/watt.svg" alt="hot"  style={{width:"43px"}}/>
                                                <h4 className='cbm-h4'>{item.p2}</h4>
                                            </div>
                                            </div>
                ...
                <div className="row">
                    <div className="col-8">
                        <div className="filling big">
                            <img src="./img/filling.svg" alt="filling-img" style={{width:"600px"}}/>
